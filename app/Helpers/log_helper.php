...
{
    // Get current domain - this will be used to associate the log message with the correct domain in the logging service
    // Reuse the Urls configuration to get the cookiedomain, which is the most relevant domain for logging purposes
    $currentDomain = config('Urls')->cookiedomain ?? 'localhost';
